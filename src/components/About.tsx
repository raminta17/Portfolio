...
const About = () => {
	...
	return (
		<div id='About' className='py-5 d-flex flex-column about overflow-hidden'>
			<div
				className='content mx-auto p-3 d-flex flex-column gap-5 about'
				ref={ref}
			>
				<h2 className='bottomBorder pb-3'>ABOUT</h2>
				<div
					style={styleAbout}
					className='d-flex align-items-center md-column gap-5'
					ref={textRef}
				>
					...
					<div className='d-flex flex-column md-align-center gap-3'>
						<div>
							I'm Raminta Ališauskaitė, Full Stack Web developer based in
							Vilnius, Lithuania.
						</div>
						<div>
							After a 7 year career as a physiotherapist in Scotland, I
							discovered my passion for software development and it inspired me
							to pursue a new career path. Programming became a source of joy
							for me as I learned to craft full stack applications using React,
							JavaScript/Typescript and Node.js. What started as an interest
							soon became therapeutic, and I realized that I had found a career
							that seamlessly became my favorite hobby.
						</div>
						<div>
							{' '}
							What sets me apart is my unwavering sense of responsibility,
							loyalty, adaptability, proactiveness, and thirst for continuous
							learning and improvement. I am excited about the possibilities
							that lie ahead and am eager to connect with like-minded
							individuals and innovative teams. If you're looking for a
							dedicated and adaptable developer, I would love to hear from you.
