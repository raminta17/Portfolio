                ...
                <div
                    ...
                    <div className="d-flex flex-column gap-3">
                        ...
                        <div>After a 7 year career as a physiotherapist in Scotland, I discovered my passion for
                            software development. This realization inspired me to pursue a new career path. I successfully
                        ...
                        <div> Programming became a source of joy for me as I learned to craft code that
                            ...
                            functionality, using JavaScript and back-end programming with Node.js.
                        ...
                        <div> What sets me apart is my unwavering sense of responsibility, loyalty, adaptability,
                            proactiveness, and an insatiable thirst for learning. My journey has exposed me to
                            collaborative team environments and independent work, allowing me to fine-tune my skills in
                            diverse settings. I look forward to an opportunity to contribute my skills and
                            enthusiasm to a dynamic and innovative field.
                        </div>
                    </div>
                </div>
            </div>
