...
const Education = () => {
    ...
    function changeImageIndex(direction: string) {
        if (direction === 'left') {
            imageIndex === 0 ? setImageIndex(educationPdf.length - 1) : setImageIndex(imageIndex - 1);
            return;
        }
        imageIndex === educationPdf.length - 1 ? setImageIndex(0) : setImageIndex(imageIndex + 1);
    }
            ...
            <div className="content mx-auto p-3 d-flex flex-column gap-5" ref={ref}>
                ...
                <div className="d-flex gap-5 md-column" ref={textRef} style={styleAbout}>
                    ...
                    <div className="f1 d-flex flex-column gap-3">
                        ...
                        <div>
                            One of the
                            highlights of this course was being a part of a small, high-achieving group to
                            collaborate on creating an admin page for our lecturer's upcoming project, scheduled for
                            release
                            early next year. This experience not only honed my teamwork and problem-solving skills but
                            also
                            allowed me to contribute to a real-world project with tangible impact.
                        </div>
                    </div>
                    <div className="f1 projectImages">
                        <div className="mainImage"><img src={educationPdf[0]}/></div>
